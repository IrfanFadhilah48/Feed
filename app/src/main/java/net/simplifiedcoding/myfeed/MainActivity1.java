...
public class MainActivity1 extends AppCompatActivity implements RecyclerView.OnScrollChangeListener {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Config.DATA_URL + String.valueOf(requestCount),
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(MainActivity1.this, "No More Items Available", Toast.LENGTH_SHORT).show();
                    }
                });
